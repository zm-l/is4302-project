...
contract("Full Workflow Test", accounts => {
    ...
    it("Same vote", async () => {
        ...
        await astraea.addProposition(tweetId, web3.utils.toWei('50', 'ether'), web3.utils.toWei('50', 'ether'), { from: accounts[0] });
        ...
        await astraea.addPlayer(accounts[1]);
        await astraea.addPlayer(accounts[2]);

        await astraea.certifyProposition(0, false, web3.utils.toWei('47', 'ether'), { from: accounts[2] });
        await astraea.voteOnProposition(0, false, web3.utils.toWei('5', 'ether'), { from: accounts[1] });



        //await astraea.distributeRewards(tweetId);
    ...
    it("Different vote", async () => {
        ...
        const tweetId = createTx.logs[0].args.tweetId.toNumber();
        await astraea.addProposition(tweetId, web3.utils.toWei('50', 'ether'), web3.utils.toWei('50', 'ether'), { from: accounts[3] });
        ...
        await astraea.certifyProposition(1, false, web3.utils.toWei('47', 'ether'), { from: accounts[1] });
        await astraea.voteOnProposition(1, true, web3.utils.toWei('5', 'ether'), { from: accounts[2] });
