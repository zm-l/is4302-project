...
contract ASTREA {
    ...
    event PropositionAdded(string tweetURL, uint256 bountyAmount, uint256 rewardPool);
    ...
    function addProposition(string memory _tweetURL, uint256 _bountyAmount, uint256 _rewardPool) public {
        require(_bountyAmount <= karmaTokenContract.balanceOf(msg.sender), "Insufficient KarmaTokens to provide as bounty.");
